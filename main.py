...
def attack(char_name, char_class):
    """Функция подсчета урона от атаки."""
...
def defence(char_name, char_class):
    """Функция подсчета защиты от атаки противника."""
    if char_class == 'warrior':
...
def special(char_name, char_class):
    """Функция подсчета применения специальсного умения."""
    if char_class == 'warrior':
